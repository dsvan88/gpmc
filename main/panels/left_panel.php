<aside id='left-panel'>
	...
	<div class='left-panel__button' id='RatingGamers'>
		<a href='/?trg=rating'>
			<?=$engine->checkAndPutImage($settings['img']['rating']['value'],$settings['img']['rating']['name'])?>
			<span>Рейтинг</span>
		</a>	
	</div>
	<?if (isset($_SESSION['id'])):?>
		<div class='left-panel__button'>
			<a href='<?='/?profile=',$_SESSION['id']?>'>
				<?=$engine->checkAndPutImage($img_genders[$_SESSION['gender']],'Профиль')?>
				<span>Профиль</span>
			</a>
		</div>
	<?endif;
	if (isset($_SESSION['status']) && $_SESSION['status'] > 0):
		...
		<div class='left-panel__button'>
			<a href='/?trg=voting'>
				<?=$engine->checkAndPutImage($settings['img']['voting']['value'],$settings['img']['voting']['name'])?>
	...
	<div class='left-panel__button'>
		<a href='/?trg=about'>
			<?=$engine->checkAndPutImage($settings['img']['about']['value'],$settings['img']['about']['name'])?>
			<span>О нас</span>
		</a>
	</div>
</aside>