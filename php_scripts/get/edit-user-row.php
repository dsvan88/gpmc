...
$result['html'] = '
	...
	<td>
		<input type="text" name="name" value="'.$user['name'].'" size="8"/>
	</td>
	<td>
		<input type="text" name="fio" value="'.$user['fio'].'" size="8"/>
	</td>
	<td>
		<select name="status">';
	...
	<td>
		<input type="text" name="birthday" value="'.($user['birthday'] > 0 ? date('d.m.Y',$user['birthday']) : '').'" size="8"/>
	</td>
	<td>
		<select name="gender">';
	...
	<td></td>
	<td>
		<input type="text" name="email" value="'.$user['email'].'" size="15"/>
	</td>
	<td>
		<input type="checkbox" name="ar" value="1"'.($user['ar'] > 0 ? ' checked disabled' : '').'/>
	</td>
	<td></td>
	<td>
