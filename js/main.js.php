...
var EveningID = <?=isset($EveningData['id']) && $EveningData['id'] > 0 ? $EveningData['id'] : -1?>;
$(function(){
	...
	$('#LogInDiv,#MainBody,.modal_window').off('click','#Welcome');
	$('#LogInDiv,#MainBody,.modal_window').on('click','#Welcome', function(){
		$.ajax({
			url:'switcher.php'
			, type:'POST'
			, data:'need=login_form'
